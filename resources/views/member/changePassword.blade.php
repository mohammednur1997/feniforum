      ...
      <!-- Container fluid  -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form id="paypal_donate_form_onetime_recurring" action="{{ route('member.password') }}" method="post">
                    @csrf
                <div class="row">
                    ...
                    <input type="text" hidden="" name="email" value="{{ Auth::guard('member')->user()->email}}">
