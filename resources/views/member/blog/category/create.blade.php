...
@endpush()
   ...
   <!-- Container fluid  -->
    ...
    <form class="needs-validation" role="form" action="{{route('blogCat.store')}}" method="post" novalidate enctype="multipart/form-data">
                      ...
                      {{csrf_field()}}
                                  ...
                                  <div class="form-group">
                                       ...
                                       <input type="text" tabindex="1" name="name" class="form-control" id="validationCustom02" placeholder="{{translate('category_name')}}" value="{{ old('category_name') }}" required>
                                 ...
                                 <div class="form-group">
                                      ...
                                      <select class="form-control  custom-select" name="parent" id="validationCustom02" style="width: 100%; height:36px;" required>
