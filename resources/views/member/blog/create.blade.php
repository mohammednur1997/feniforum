...
@endpush()
   ...
   <!-- Container fluid  -->
    ...
    <form class="needs-validation" role="form" action="{{route('memberblog.store')}}" method="post" novalidate enctype="multipart/form-data">
                      ...
                      {{csrf_field()}}
                                  ...
                                  <div class="form-group">
                                       ...
                                       <input type="text" tabindex="1" name="blog_title" class="form-control" id="validationCustom02" placeholder="{{translate('blog_title')}}" value="{{ old('blog_title') }}" required>
                                ...
                                <div class="form-group">
                                       ...
                                       <input type="file" tabindex="1" name="fet_image" class="form-control" id="validationCustom02" placeholder="{{translate('fet_image')}}" value="{{ old('fet_image') }}" required>
                                        <div class="invalid-feedback">
                                 ...
                                 <div class="form-group">
                                      ...
                                      <select class="form-control  custom-select" name="cat_id" id="validationCustom02" style="width: 100%; height:36px;" required>
