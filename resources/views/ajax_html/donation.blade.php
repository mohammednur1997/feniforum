      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form id="popup_paypal_donate_form_onetime_recurring">
            <div class="row">
              <div class="col-md-12">
                <img src="{{ asset('static/front_end/images/payment-card-logo-sm.png') }}" alt="">
...
<?php
$campaing =  App\Campaing::where('db_status','Live')->orderBy('id','DESC')->take('15')->get();
?>
                ...
                <div class="form-group mb-20">
                  ...
                  <select name="item_name" class="form-control">
				   @foreach($campaing as $campaings)
                    <option value="{{ $campaings->id }}">{{ $campaings->title }}</option>
                   @endforeach
                  </select>
                </div>
              </div>
