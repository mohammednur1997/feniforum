...
@endpush()
                                    ...
                                    <table id="myTable" class="table table-striped table-bordered">
                                       ...
                                       @foreach($event as $value)
                                            <tr>
                                                <td>{{ $value->title }}</td>
                                                <td>
                               @foreach(App\EventName::where('id', $value->eventName_id)->get() as $eventname)     
 ...
 <img height="50px" width="50px" src="{{ asset('upload/images/event/'. $image->image) }}">          
                                    ...
                                    <a href="{{ route('admin.eventpage', $value->id) }}" class="btn btn-info">Edit</a>
                                     ...
                                     <a onclick="return confirm('Are You Sure went to delete data')" href="{{ route('admin.event.destroy', $value->id) }}" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                      @endforeach
                                        </tbody>
