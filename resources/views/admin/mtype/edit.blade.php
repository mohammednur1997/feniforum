                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="{{route('mtype.index')}}">{{ translate('mtype')}}</a>
                                    </li>
...
@endpush()
   ...
   <!-- Container fluid  -->
    ...
    <form class="needs-validation" role="form" action="{{route('mtype.update', $editType->id)}}" method="post" novalidate enctype="multipart/form-data">
