...
@section('breadcrumb')
            ...
            @endpush()
                ...
                <div class="col-12">
                      ...
                      <td>
                        ...
                        <!-- <a href="{{ route('member.edit', $value->id) }}" class="btn btn-sm btn-info"> {{translate('Add Committee')}} </a> -->
  ...
  <input type="hidden" name="parmanent_address" value="{{ $value->parmanent_address }}">
        ...
        <input type="text" tabindex="1" name="committe_name" class="form-control" id="validationCustom02" placeholder="{{translate('name')}}" value="{{ old('name') ? old('name') : $committeemember->name}}" required>
              ...
              ?>
                ...
                <option value="{{ $memcs->id }}" <?php if($committeemember->years==$memcs->id) { echo"selected";} ?>>{{ $memcs->name }}</option>
              @endforeach
          ...
          <option value="{{ $ctvalue->id }}" <?php if($committeemember->comite==$ctvalue->id) { echo"selected";} ?>>{{ $ctvalue->name }}</option>
           <?php endforeach ?>
           ...
           <div class="form-group">
            ...
            <input type="number" class="form-control" name="priority" placeholder="Write member priority">
               ...
               <div class="form-group">
                    ...
                    <textarea name="note" id="ckeditor" rows="5" cols="5" class="ckeditor">{{ old('note') ? old('note') : $committeemember->note}}</textarea>
                  </div>
