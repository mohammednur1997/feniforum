                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">
                                        <a href="{{route('designation.index')}}">{{ translate('designation')}}</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ translate('designation')}}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
@endsection
@section('title', translate('designation'))
...
@endpush()
   ...
   <!-- Container fluid  -->
    ...
    <form class="needs-validation" role="form" action="{{route('designation.update', $editType->id)}}" method="post" novalidate enctype="multipart/form-data">
