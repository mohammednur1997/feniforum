                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ translate('member_type')}}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
@endpush()
   ...
   <!-- Container fluid  -->
    ...
    <form class="needs-validation" role="form" action="{{route('mtype.store')}}" method="post" novalidate enctype="multipart/form-data">
