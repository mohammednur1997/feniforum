    ...
    <form class="needs-validation" role="form" action="{{route('member.store')}}" method="post" novalidate enctype="multipart/form-data">
                      ...
                      {{csrf_field()}}
                                  ...
                                  <div class="form-group">
                                       <label for="member_full_name">{{ translate('member_full_name')}}</label> <span class="text-danger">*</span>
                                       <input type="text" name="full_name" class="form-control"  placeholder="{{translate('member_full_name')}}"  required>
                                   ...
                                   <div class="form-group">
                                       <label for="father_name">{{ translate('father_name')}}</label> <span class="text-danger">*</span>
                                       <input type="text"  name="father_name" class="form-control" placeholder="{{translate('father_name')}}"  required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                       <label for="validationCustom02">{{ translate('mobile Home')}}</label> <span class="text-danger">*</span>
                                 ...
                                 <div class="form-group">
                                       <label for="validationCustom02">{{ translate('mobile work')}}</label> <span class="text-danger">*</span>
                                       <input type="text" tabindex="1" name="mobile_work" class="form-control" id="validationCustom02" placeholder="{{translate('mobile_work')}}" value="{{ old('mobile_work') }}" onkeypress='return event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)'>
                                        <div class="invalid-feedback">
                                           {{translate('please_add_mobile')}}
                                        </div>
                                  ...
                                  <select class="form-control" id="upozila_id" name="upozila_id" required>
                                    <option value="">Select Your Upozila</option>
                                   <?php
                                  $upozila =  App\Upozila::where('db_status','Live')->orderBy('id','desc')->get();
                                  ?>
                                    @foreach($upozila as $upozilas) 
                                    <option value="{{ $upozilas->id }}">{{ $upozilas->name }}</option>
                                  @endforeach
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                       <label for="member_id">{{ translate('member_id')}}</label> <span class="text-danger">-Last Member ID:
                                    @php
                        $membersref =  App\UserProfile::orderBy('member_id','desc')->first();
                                    @endphp
                                    {{ $membersref->member_id  }}
                                       </span>
                                       <input type="text"  name="member_id" class="form-control"  placeholder="{{translate('member_id')}}"  required>
                                        <div class="invalid-feedback">
                            ...
                            <select class="form-control" name="referane_name" >
                              <option value="">Select Member</option>
                             <?php
                            $membersref =  App\UserProfile::where('status','20')->where('db_status','Live')->orderBy('id','desc')->get();
                            ?>
                              @foreach($membersref as $refmem) 
                              <option value="{{ $refmem->full_name }}">{{ $refmem->full_name }}-{{ $refmem->member_id }}</option>
                            @endforeach
