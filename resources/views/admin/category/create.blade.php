...
@endpush()
   ...
   <!-- Container fluid  -->
    ...
    <form class="needs-validation" role="form" action="{{route('category.store')}}" method="post" novalidate enctype="multipart/form-data">
                         
                      {{csrf_field()}}

                                  <div class="form-group">
                                       <label for="validationCustom02">{{ translate('category_name')}}</label> <span class="text-danger">*</span>
                                       <input type="text" tabindex="1" name="category_name" class="form-control" id="validationCustom02" placeholder="{{translate('category_name')}}" value="{{ old('category_name') }}" required>
                                 ...
                                 <div class="form-group">
                                      ...
                                      <textarea name="description" id="description" rows="5" cols="5" class="form-control"></textarea>
                                </div>
