                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="font-16 m-b-5">{{translate('Total_money')}}</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h1 class="font-light text-right">{{ $Money }}</h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="font-16 m-b-5">{{translate('total_Collection_from_doner')}}</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h1 class="font-light text-right">{{App\Donation::sum('amount') }}</h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            <i class="mdi mdi-poll font-20 text-muted"></i>
                                            <p class="font-16 m-b-5">{{translate('total')}}</p>
                                        </div>
                                        <div class="ml-auto">
                                            <h1 class="font-light text-right">{{$Money + App\Donation::sum('amount') }}</h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
