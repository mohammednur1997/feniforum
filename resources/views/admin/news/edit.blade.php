                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{ translate('news-_edit')}}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
@endsection
@section('title', translate('edit_news'))
...
@endpush()
   ...
   <!-- Container fluid  -->
    ...
    <form class="needs-validation" role="form" action="{{route('news.update', $editnews->id)}}" method="post" novalidate enctype="multipart/form-data">
                      ...
                      {{method_field('put')}}
                                  ...
                                  <div class="form-group">
                                       ...
                                       <input type="text" tabindex="1" name="title" class="form-control" id="validationCustom02" placeholder="{{translate('category_name')}}" value="{{ old('title') ? old('title') : $editnews->title}}" required>
                                 ...
                                 <div class="form-group">
                                      ...
                                      <textarea name="description" id="ckeditor" rows="5" cols="5" class="ckeditor">{{ old('description') ? old('description') : $editnews->description}}</textarea>
